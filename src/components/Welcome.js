...
class Welcome extends React.Component {
  render() {
  	return (
        <section className="section pt-5" id="welcome">
           <div class="welcome">
		<div class="container">
			<div class="row">					
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="about_content">
							<div class="welcome-top-text">"Bring Your Whole Self to Work & Optimize Your Performance"</div>
							<div className="text-muted web-desc">
								...
								<p>
                                Intelligent, purpose driven productivity and performance is the heartbeat 
...
{/* 
					...
					<div class="col-lg-6">
						...
						<div class="container">
							<div class="row">
							<div class="button"><a href="#"><span>read more</span><span>read more</span></a></div>
						</div>
						</div>
						{/* <a href="#vision" class="txt4">
						Learn More About Us
