        ...
        <section className="cta bg-light">
            <div className="container">
                <div className="row">
                    ...
                    <p className="margin-b-0 contact-title"><i className="pe-7s-call"></i> &nbsp;678-672-73-15</p>
                    </div>
                    <div className="col-lg-3 margin-t-30 text-right">
                        <p className="contact-title"><i className="pe-7s-mail-open"></i>&nbsp; support@truelifepurpose.com</p>
                    </div>
                </div>
            </div>
        </section>
