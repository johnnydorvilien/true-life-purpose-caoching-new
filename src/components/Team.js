            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 offset-lg-2">
                        ...
                        <p className="section-subtitle text-muted text-center font-secondary padding-t-30">Meet our coaches whom have gone through the work and struggles themselves, and they look forward to helping guide you toward the life of purpose.</p>
                    </div>
                </div>
